              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="php/sell.php" method="post">
                      <div class="form-group">
                        <label for="exampleInputName1">Buyer</label>
                        <input type="text" name="buyer" class="form-control" id="exampleInputName1" placeholder="Name" Required>
                      </div>
                    ...
                    <div class="form-group">
                        <label for="exampleInputMobile" >Quantity</label>
                         <input type="number" name="quantity" class="form-control" id="inpc" placeholder="Weight" Required>                      
                      </div>
<p id="test1"></p>
                    <div class="form-group">
                        <label for="exampleInputMobile" >Price</label>
                         <input type="text" name="price" class="form-control" id="exampleInputMobile" placeholder="Mobile number" Required>
                       
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Remark</label>
                        <textarea class="form-control" name="remark" id="exampleTextarea1" rows="4"></textarea>
                      </div>
