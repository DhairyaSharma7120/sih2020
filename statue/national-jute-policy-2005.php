...
<section class="text-gray-700 body-font overflow-hidden">
  <div class="container px-5 py-24 mx-auto">
    <div class="-my-8">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900" style="font-weight: bold;">National Jute Policy 2005</h1>
    </div>
    </div>
      ...
      <a class="text-indigo-500 inline-flex items-center mt-4" style="margin-left:35%; text-size: 50%;" href="..\documents\national-jute-policy-2005\NATIONAL JUTE POLICY 2005.pdf" target="_blank" style="font-weight: bold; font-size: 90%;">National Jute Policy 2005 - download in pdf format
           
         </a>
       </div></div>
        
      
      <div class="py-8 flex border-t-2 border-gray-200 flex-wrap md:flex-no-wrap"></div>
  </div>
</div>
</section>
